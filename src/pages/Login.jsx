    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-white dark:bg-dark-bg">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          <p className="text-text-secondary dark:text-dark-text-secondary text-sm mt-1">Welcome back</p>
        </div>
        ...
        <p className="text-center text-sm text-text-secondary dark:text-dark-text-secondary mt-6">Don't have an account?{' '}<Link to="/signup" className="text-primary font-medium hover:underline">Start your free trial</Link></p>
      </div>
    </div>
  )
}
